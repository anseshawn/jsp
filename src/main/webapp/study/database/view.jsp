	      ...
	      <td colspan="2">
	      	<div class="row">
	      		<div class="col text-left">
			        <input type="button" value="돌아가기" onclick="location.href='${ctp}/study/database/LoginList';" class="btn btn-warning mr-4"/>
			        <!-- <input type="button" value="돌아가기" onclick="history.back()" class="btn btn-warning mr-4"/> -->
		        </div>
		        <div class="col text-right">
			        <input type="submit" value="회원정보 수정" class="btn btn-primary mr-2"/>
