...
<div class="container">
	<h2>세션 연습 메인 메뉴</h2>
	<!-- 세션: 브라우저 , 사용자의 브라우저에 따라 달림 브라우저를 키고 끄는 것에 따라서 세션이 살아나고 소멸됨 -->
	<!-- 같은 브라우저는 브라우저를 닫지 않고 새 창을 열면 세션이 같음 다른 브라우저는 세션이 다름 -->
	<hr/>
  <form name="myform" method="post" action="t2_SessionSave.jsp">
    <table class="table table-bordered text-center">
      ...
      <tr>
        <td colspan="2">
					<button type="submit" class="btn btn-primary mr-3 btn-sm">세션저장</button>
					<a href="t2_SessionCheck.jsp" class="btn btn-info mr-3 btn-sm">세션확인</a>
