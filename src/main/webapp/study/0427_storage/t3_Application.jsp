...
<div class="container">
  ...
  <form name="myform" method="post" action="t3_ApplicationSave.jsp">
    <table class="table table-bordered text-center">
      ...
      <tr>
        <td colspan="2">
					<button type="submit" class="btn btn-primary mr-3 btn-sm">어플리케이션저장</button>
					<a href="t3_ApplicationCheck.jsp" class="btn btn-info mr-3 btn-sm">어플리케이션확인</a>
					<a href="t3_ApplicationDelete.jsp" class="btn btn-warning mr-3 btn-sm">부분어플리케이션삭제</a>       
        </td>
      </tr>
    </table>
  </form>
