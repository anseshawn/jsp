...
<div class="container">
	...
	<hr/>
	<p>
		<a href="t4_ApplicationClear.jsp" class="btn btn-primary">어플리케이션 카운트 초기화</a>
		<a href="t4_SessionClear.jsp" class="btn btn-success">세션 카운트 초기화</a>
		...
		<!-- location.reload가 잘 안먹으면 주소를 다시 불러오기 -->
	</p>
</div>
<p><br/></p>
