...
<div class="container">
	...
	<pre>
		...
		트랜잭션은 'ACID'라는 '원자성/일관성/격리성/지속성'을 보장해야 한다.
		*(데이터베이스 연동 객체에 주는 것이 좋음)
		...
		​
		4. 지속성(Durability)
			지속성은 트랜잭션이 성공적으로 완료됬을 경우, 결과는 영구적으로 반영되어야 한다는 점이다. 즉, 그 결과가 항상 기록되어야 한다.
			그래야 중간에 시스템에 문제가 발생해도 데이터베이스 로그등을 사용해서 성공한 프랜잭션 내용을 복구할수 있게한다.
