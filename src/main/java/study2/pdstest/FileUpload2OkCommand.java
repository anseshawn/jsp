...
public class FileUpload2OkCommand implements StudyInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("원본파일명 oFileName1 : "+oFileName1);
		System.out.println("원본파일명 oFileName2 : "+oFileName2);
		System.out.println("원본파일명 oFileName3 : "+oFileName3);
		System.out.println("서버에 저장된 파일명 1 : "+fsName1);
		System.out.println("서버에 저장된 파일명 2 : "+fsName2);
		System.out.println("서버에 저장된 파일명 3 : "+fsName3);
